...
<form method="post" action="index.php?act=signin" name='theForm' onsubmit="return validate()">
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
      <td colspan="2" align="right"><img src="index.php?act=captcha&1033109055" width="145" height="20" alt="CAPTCHA" border="1" onclick= 'this.src="index.php?act=captcha&"+Math.random()' style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>
